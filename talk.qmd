...
![Hydrogel beads ($d \sim 1~\textrm{cm}$) down a slope ($\alpha = 45^\circ$) from a non-suspended initial condition.](talk_files/src/videos/LEGI/grosse_hydrogel_mieux.mp4){width="60%" fig-align="center"}
